...
func NewTestServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) TestServiceClient {
	...
	return &testServiceClient{
		method: connect.NewClient[Request, Response](
			httpClient,
...
type testServiceClient struct {
	method *connect.Client[Request, Response]
}

// Method calls connect.test.same_package.TestService.Method.
func (c *testServiceClient) Method(ctx context.Context, req *connect.Request[Request]) (*connect.Response[Response], error) {
...
func (UnimplementedTestServiceHandler) Method(context.Context, *connect.Request[Request]) (*connect.Response[Response], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("connect.test.same_package.TestService.Method is not implemented"))
}
