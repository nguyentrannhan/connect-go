...
import (
	...
	gen "github.com/nguyentrannhan/connect-go/cmd/protoc-gen-connect-go/internal/testdata/diffpackage/gen"
)
...
func NewTestServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) TestServiceClient {
	...
	testServiceMethods := gen.File_diffpackage_proto.Services().ByName("TestService").Methods()
...
// Method calls connect.test.different_package.TestService.Method.
...
func (UnimplementedTestServiceHandler) Method(context.Context, *connect.Request[gen.Request]) (*connect.Response[gen.Response], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("connect.test.different_package.TestService.Method is not implemented"))
}
