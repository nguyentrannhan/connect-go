...
const file_connect_ping_v1_ping_proto_rawDesc = "" +
	"\n" +
	...
	"\x13com.connect.ping.v1B\tPingProtoP\x01Z:github.com/nguyentrannhan/connect-go/internal/gen/connect/ping/v1;pingv1\xa2\x02\x03CPX\xaa\x02\x0fConnect.Ping.V1\xca\x02\x0fConnect\\Ping\\V1\xe2\x02\x1bConnect\\Ping\\V1\\GPBMetadata\xea\x02\x11Connect::Ping::V1b\x06proto3"

var (
	file_connect_ping_v1_ping_proto_rawDescOnce sync.Once
	file_connect_ping_v1_ping_proto_rawDescData []byte
)

func file_connect_ping_v1_ping_proto_rawDescGZIP() []byte {
	file_connect_ping_v1_ping_proto_rawDescOnce.Do(func() {
		file_connect_ping_v1_ping_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_connect_ping_v1_ping_proto_rawDesc), len(file_connect_ping_v1_ping_proto_rawDesc)))
	})
...
var file_connect_ping_v1_ping_proto_goTypes = []any{
...
func file_connect_ping_v1_ping_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_connect_ping_v1_ping_proto_rawDesc), len(file_connect_ping_v1_ping_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   10,
			NumExtensions: 0,
			NumServices:   1,
